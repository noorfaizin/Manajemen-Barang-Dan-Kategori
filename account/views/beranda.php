    ...
    <div class="carousel-item active">
      ...
      <div id="head-pil1" class="p-3">
        ...
        <div class="mt-5">
          ...
          <a href="#" class="btn btn-outline-warning btn-lg mr-2">Contact</a>
        </div>
      </div>
    </div>
    ...
    <div class="row col-md-12 mt-3 mb-5">
      <div class="col-sm-2">
          <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
              ...
              <small class="text-muted mt-2 ml-2">Harga</small>
                <a id="btnpills" onclick="openPills('lowprice')" class="nav-link text-dark" data-toggle="pill" role="tab" aria-selected="true" style="cursor:pointer;">Harga Terendah</a>
          </div>
      </div>
      ...
      <div class="row col-md-10">
        ...
        <div id="lowprice" class="w3-container pills row col-md-12" style="display:none;">
          <div class="tab-content" id="lowprice">
            <div class="tab-pane text-left fade show active" role="tabpanel">
              <h4 class="font-weight-bold p-3 ml-3 rounded shadow" style="background-image: linear-gradient(to right, #f8f9fa , transparent);">Harga Terendah</h4>
              <div class="row col-md-12">
              <?php foreach($lowprice as $low){ ?>
              <div class="col-list-3">
                <div class="recent-car-list rounded">
                  <div class="col-lg text-dark d-flex justify-content-center">
                    <div class="card m-0 shadow">
                      <div class="card-header bg-dark">
                        <h5 class="card-title m-0 text-white"><?php echo $low->prod_name ?></h5>
                      </div>
                      <img src="<?= base_url()?>gambar/<?php echo $low->prod_img?>" class="card-img-top mt-4" style="width:50%;margin:auto;" alt="image">
                      <div class="card-body mx-auto" style="margin-bottom:-30px;">
                        <td><h4 class="font-weight-light">Rp. <?php echo number_format($low->prod_price) ?></h4></td>
                      </div><hr>
                      <div class="row col-md-12 mb-3 mx-auto">
                        <div class="row col-md-4 mx-auto">
                          <?php echo anchor('beranda/detail/'.$p['prod_id'],'<div class="btn btn-outline-dark btn-md">Detail</div>')?>
                        ...
                        <div class="row col-md-8 mx-auto">
                          <?php echo anchor('cart/add_cart/'.$low->prod_id,'<div class="btn btn-warning mx-auto"><i class="fas fa-cart-plus"></i> Beli Sekarang</div>')?>
                        </div>
                      </div>
                    </div>
                  </div>
...
<div class="row mx-auto pb-5" style="width:100%;">
    ...
    <a href="#" class="btn btn-outline-warning btn-lg mr-2">Lihat Semua</a>
