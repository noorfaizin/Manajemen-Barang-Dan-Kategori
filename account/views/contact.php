...
<div class="row mx-auto pb-5 pt-5 bg-light" style="width:100%;">
  ...
  <div class="row col-md-12 mx-auto">
    <div class="col-md-10 mx-auto card">
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <form class="form-horizontal col-md-12" action="#" method="post" enctype="multipart/form-data" role="form">
            ...
            <div class="col-md-7">
              ...
              <div class="input-group">
                  ...
                  <label class="col-md-12 control-label">No HP</label>
                      <div class="col-md-12">
                          <input type="text" class="form-control" placeholder="No.Telp" name="nohp" value="">
                      </div>
                  </div>
                  <div class="form-group col-md-6">
